...
|-----------------|-------------------------------|------------|
| **Regresión**   | Predicción de valores numéricos. | ![Regresión](/home/cesar/teaching/Python-ML/images/Regression.png){height=50px} |
| **Clasificación** | Asignación de categorías.       | ![Clasificación](/home/cesar/teaching/Python-ML/images/Classification.jpg){height=50px} |
| **Clustering**  | Agrupación sin etiquetas.      | ![Clustering](/home/cesar/teaching/Python-ML/images/Clustering.jpg){height=50px} |
| **Lenguaje Natural (NLP)** | Procesamiento de texto y voz.  | ![NLP](/home/cesar/teaching/Python-ML/images/NLP.png){height=50px} |
