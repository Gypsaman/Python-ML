...
[X] Definición de agente y el loop
[X] IA vs procesos deterministas
[X] Tipos de mensajes: system, user, assistant
[X] Definición de herramientas (JSON schema)
[X] Ciclo completo de tool use
[X] stop_reason y el loop del agente
[X] Agente funcional con la API de Claude
