...
[X] Patrones de razonamiento: ReAct, CoT, Plan-Execute
[X] Estado y memoria: contexto, working memory, externa
[X] Gestión de ventana de contexto
[X] Patrón Orquestador + Subagentes
[X] Agentes especializados (datos, análisis, escritura)
[X] Guardrails y diseño responsable
[X] Sistema multi-agente completo
